...
A Python CLI package to sync markdown files to Notion (and potentially other platforms in the future). One-way sync from markdown → platform with focus on simplicity and excellent markdown parsing.
